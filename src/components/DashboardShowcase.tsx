  ...
  return (
    <section className="py-20 px-6 relative">
      <div className="max-w-7xl mx-auto">
        ...
        >
          {/* 👇 Scaled container for the whole demo frame */}
          <div
            className="origin-top w-full max-w-6xl flex justify-center"
            style={{ transform: "scale(1, 1)" }}
          >
            {/* Browser Frame */}
            <div className="bg-[#2A2A2A] rounded-t-xl border border-[#46675D]/20 shadow-2xl w-full">
              {/* Browser Header */}
              <div className="flex items-center justify-between p-4 border-b border-[#46675D]/20">
                ...
                <div className="flex-1 mx-4">
                  <div className="bg-[#1F1F1F] rounded-md px-4 py-1 text-sm text-gray-400 text-center truncate">
                    ...
                    {!isLoading && (
                      <motion.div
                        ...
                        animate={{
                          opacity: 1,
                          x: [
                            100, 100, 180, 180, 300, 300, 450, 450,
                            380, 380, 250, 250, 400, 400, 520, 520, 100
                          ],
                          y: [
                            100, 100, 140, 140, 180, 180, 240, 240,
                            320, 320, 120, 120, 280, 280, 80, 80, 100
                          ]
                        }}
                        transition={{
